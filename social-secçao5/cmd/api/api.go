...
import (
	...
	store "github.com/sikozonpc/social/internal/env/store/cache"
...
func (app *application) run(mux http.Handler) error {
	...
	go func() {
		...
		signal.Notify(quit, syscall.SIGNIT, syscall.SIGTERM)
		s := <-quit
	...
	app.logger.Infof("server has started on %s env=%s", app.config.addr, app.config.env)
